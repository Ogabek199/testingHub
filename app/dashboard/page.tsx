...
export default function DashboardPage() {
  ...
  const triggerNewTest = () => {
    ...
    toastSuccess("Yangi test muvaffaqiyatli ishga tushirildi! (" + testId + ")", "Test Suite");
  };
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="ios-card p-5">
          ...
          <span className="text-2xl font-black text-foreground">6 ta loyiha</span>
          <span className="text-[11px] text-emerald-600 dark:text-emerald-400 block mt-1">
            4 ta aktiv tekshiruvda
          </span>
        </div>
        ...
        <div className="ios-card p-5">
          ...
          <span className="text-2xl font-black text-coral-600 dark:text-coral-400">142 ta bug</span>
          <span className="text-[11px] text-muted-foreground block mt-1">
            38 ta kritik bartaraf etildi
          </span>
        </div>
        ...
        <div className="ios-card p-5">
          ...
          <span className="text-[11px] text-muted-foreground block mt-1">
            Production zararlaridan tejalgan
          </span>
        </div>
      </div>
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Onlayn kalkulyatordan kelib tushgan loyiha smetalari va mijoz kontaktlari
              </p>
            </div>
            <span className="text-xs font-bold px-2.5 py-1 rounded-full bg-primary/10 text-primary">
              {quotes.length} ta so&apos;rov
            </span>
          </div>
            ...
            <table className="w-full text-left text-xs">
              <thead className="text-muted-foreground border-b border-black/[0.06] dark:border-white/[0.06] uppercase tracking-wider">
                <tr>
                  ...
                  <th className="pb-3 font-semibold">Mijoz / Aloqa</th>
                  <th className="pb-3 font-semibold">Tanlangan xizmatlar</th>
                  <th className="pb-3 font-semibold">Smeta narxi</th>
          ...
          <div className="lg:col-span-4 space-y-6">
              ...
              <div className="space-y-3 text-xs">
                <div className="p-3 rounded-xl bg-red-500/10 border border-red-500/20">
                  ...
                  <p className="text-muted-foreground mt-1">
                    To&apos;lov vaqtida foydalanuvchi sessiyasi uzilib qolmoqda.
                  </p>
                </div>
                ...
                <div className="p-3 rounded-xl bg-amber-500/10 border border-amber-500/20">
                  ...
                  <p className="text-muted-foreground mt-1">
                    Kupon kiritilganda umumiy chegirma miqdori noto&apos;g&apos;ri hisoblanmoqda.
                  </p>
                </div>
                ...
                <div className="p-3 rounded-xl bg-blue-500/10 border border-blue-500/20">
                  ...
                  <p className="text-muted-foreground mt-1">
                    iOS Safari brauzerida modal oyna ekrandan chiqib ketmoqda.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="ios-card p-6 bg-gradient-to-br from-primary/10 to-transparent border-primary/20">
              ...
              <h4 className="text-sm font-bold text-foreground">
                Shaxsiy QA injeneringiz bilan bog&apos;laning
              </h4>
              <p className="text-xs text-muted-foreground mt-1 mb-4">
                Loyiha bo&apos;yicha istalgan savol va shoshilinch testlar uchun.
              </p>
              <a
                href="https://t.me/Javohiir"
                target="_blank"
                rel="noreferrer"
                className="w-full py-2 px-3 rounded-xl bg-primary text-white text-xs font-bold text-center block shadow-coral-glow"
              >
                Telegram orqali murojaat (@Javohiir)
              </a>
            </div>
          </div>
        </div>
